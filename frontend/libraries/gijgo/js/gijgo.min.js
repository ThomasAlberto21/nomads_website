...
(gj.widget = function () {
  ...
  (window.gijgoStorage = {
    ...
    remove: function (a, b) {
      ...
      return (
        this._storage.get(b) &&
          0 === !this._storage.get(b).size &&
          this._storage.delete(a),
        c
      );
    },
  }),
  (gj.widget.prototype.initJS = function (a, b) {
    ...
    for (c in e)
      gj[b].events.hasOwnProperty(c) &&
        (this.element.addEventListener(c, e[c]), delete e[c]);
    for (plugin in gj[b].plugins)
      gj[b].plugins.hasOwnProperty(plugin) &&
        gj[b].plugins[plugin].configure(this, e, d);
    return this;
  ...
  (gj.widget.prototype.getConfigJS = function (a, b) {
    ...
    for (f in gj[b].plugins)
      gj[b].plugins.hasOwnProperty(f) &&
        (this.extend(c, gj[b].plugins[f].config.base),
        gj[b].plugins[f].config[d] &&
          this.extend(c, gj[b].plugins[f].config[d]),
        gj[b].plugins[f].config[e] &&
          this.extend(c, gj[b].plugins[f].config[e]));
    return this.extend(c, a), c.guid || (c.guid = this.generateGUID()), c;
  }),
          ...
          d[e].widgetId === b &&
            ...
            0 === d.length &&
              (document.removeEventListener(
                a,
                gj.documentManager.executeCallbacks
              ),
  ...
  (gj.core = {
    ...
    center: function (a) {
      var b = window.innerWidth / 2 - gj.core.width(a, !0) / 2,
        c = window.innerHeight / 2 - gj.core.height(a, !0) / 2;
      (a.style.position = "absolute"),
        (a.style.left = (b > 0 ? b : 0) + "px"),
        (a.style.top = (c > 0 ? c : 0) + "px");
    },
    isIE: function () {
      return (
  ...
  (gj.picker.methods = {
    initialize: function (a, b, c) {
      var d,
        ...
        f = a.element,
        g = c.createPopup(a, b);
      "wrapper" !== f.parentElement.attributes.role
        ? ((e = document.createElement("div")),
          e.setAttribute("role", "wrapper"),
          f.parentNode.insertBefore(e, f),
          e.appendChild(f))
        : (e = f.parentElement),
        gj.core.addClasses(e, b.style.wrapper),
        b.width && (e.style.width = b.width + "px"),
        (f.value = b.value || ""),
        gj.core.addClasses(f, b.style.input),
        f.setAttribute("role", "input"),
        b.fontSize && (f.style.fontSize = b.fontSize),
        "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary
          ? "small" === b.size
            ? (e.classList.add("input-group-sm"),
              f.classList.add("form-control-sm"))
            : "large" === b.size &&
              (e.classList.add("input-group-lg"),
              f.classList.add("form-control-lg"))
          : "small" === b.size
          ? e.classList.add("small")
          : "large" === b.size && e.classList.add("large"),
        b.showRightIcon &&
          ("bootstrap" === b.uiLibrary
            ? ((d = document.createElement("span")),
              d.classList.add("input-group-addon"),
              (d.innerHTML = b.icons.rightIcon))
            ...
            ? ((d = document.createElement("span")),
              ...
              (d.innerHTML =
                ...
                b.icons.rightIcon +
                "</button>"))
            : (d = gj.core.createElement(b.icons.rightIcon)),
          d.setAttribute("role", "right-icon"),
          d.addEventListener("click", function (b) {
            "none" === window.getComputedStyle(g).display
              ? a.open()
              : a.close();
          }),
          e.appendChild(d)),
        ...
        !0 !== b.footer &&
          ...
          g.addEventListener("click", function () {
            clearTimeout(a.timeout), document.activeElement !== f && f.focus();
          }));
    },
  }),
  ...
  (gj.picker.widget.prototype.init = function (a, b, c) {
    return (
      gj.widget.prototype.initJS.call(this, a, b),
      this.element.setAttribute("data-" + b, "true"),
      gj.picker.methods.initialize(
        this,
        gijgoStorage.get(this.element, "gijgo"),
        gj[b].methods
      ),
      this
    );
  ...
  (gj.picker.widget.prototype.open = function (a) {
    var b = gijgoStorage.get(this.element, "gijgo"),
      c = document.body.querySelector(
        '[role="picker"][guid="' + this.element.getAttribute("data-guid") + '"]'
      );
    return (
      (c.style.display = "block"),
      b.modal
        ? ((c.parentElement.style.display = "block"), gj.core.center(c))
        : (gj.core.setChildPosition(this.element, c),
          document.activeElement !== this.element && this.element.focus()),
      clearTimeout(this.timeout),
      gj[a].events.open(this.element),
      this
    );
  }),
  (gj.picker.widget.prototype.close = function (a) {
    ...
    return (
      ...
      b.modal && (c.parentElement.style.display = "none"),
      gj[a].events.close(this.element),
      this
    );
  }),
  (gj.picker.widget.prototype.destroy = function (a) {
    var b = gijgoStorage.get(this.element, "gijgo"),
      c = this.element.parentElement,
      d = document.body.querySelector(
        '[role="picker"][guid="' + this.element.getAttribute("data-guid") + '"]'
      ),
      e = this.element.parentElement.querySelector('[role="right-icon"]');
    return (
      b &&
        ("modal" === c.getAttribute("role") &&
        ...
        e && this.element.parentElement.removeChild(e),
  ...
  (gj.dialog.methods = {
    init: function (a) {
      return (
        gj.widget.prototype.initJS.call(this, a, "dialog"),
    ...
    localization: function (a) {
      var b = gijgoStorage.get(a.element, "gijgo");
      void 0 === b.title &&
    ...
    initialize: function (a) {
      var b, c, d, e;
      (b = gijgoStorage.get(a.element, "gijgo")),
        gj.core.addClass(a.element, b.style.content),
        gj.dialog.methods.setSize(a.element, b),
        b.closeOnEscape &&
          document.addEventListener("keyup", function (b) {
            27 === b.keyCode && a.close();
          }),
        (d = a.element.querySelector('div[data-role="body"]')),
        d ||
          ((d = document.createElement("div")),
          d.setAttribute("role", "body"),
          a.element.addChild(d)),
        gj.core.addClasses(d, b.style.body),
        (c = gj.dialog.methods.renderHeader(a, b)),
        (e = a.element.querySelector('div[data-role="footer"]')),
        e && gj.core.addClasses(e, b.style.footer),
        a
        ...
        gj.draggable &&
          (b.draggable && gj.dialog.methods.draggable(a, c),
          b.resizable && gj.dialog.methods.resizable(a)),
        b.scrollable &&
          b.height &&
          (a.element.classList.add("gj-dialog-scrollable"),
          a.element.addEventListener("opened", function () {
            a.element.querySelector('div[data-role="body"]').style.height =
              b.height -
              $header.outerHeight() -
              ($footer.length ? $footer.outerHeight() : 0) +
              "px";
          })),
        gj.core.center(a.element),
        b.modal &&
          $dialog.wrapAll(
            '<div data-role="modal" class="' + b.style.modal + '"/>'
          ),
        b.autoOpen && $dialog.open();
    },
    setSize: function (a, b) {
      b.width && (a.element.width = b.width + "px"),
        b.height && (a.element.height = b.height + "px");
    },
    renderHeader: function (a, b) {
      var c, d, e;
      return (
        (c = a.element.querySelector('div[data-role="header"]')),
        c ||
          ((c = document.createElement("div")),
          c.setAttribute("role", "header"),
          a.element.parentElement.insertBefore(c, a.element)),
        gj.core.addClasses(c, b.style.header),
        (d = c.querySelector('[data-role="title"]')),
        d ||
          ((d = document.createElement("h4")),
          d.setAttribute("role", "title"),
          (d.innerHTML = b.title),
          c.appendChild(d)),
        gj.core.addClasses(d, b.style.headerTitle),
        (e = c.querySelector('[data-role="close"]')),
        !e && b.closeButtonInHeader
          ? ((e = document.createElement("button")),
            ($closeButton = $(
              '<button type="button" data-role="close" title="' +
                gj.dialog.messages[b.locale].Close +
                '"><span>×</span></button>'
            )),
            $closeButton.addClass(b.style.headerCloseButton),
            $header.append($closeButton))
          : e && !1 === b.closeButtonInHeader
          ? (e.style.display = "node")
          : e.classList.add(b.style.headerCloseButton),
        $header
      );
    },
  ...
  (GijgoDialog = function (a, b) {
    ...
    return (
      ...
      "dialog" !== a.getAttribute("data-type") && d.init.call(c, b),
      c
    );
  }),
  ...
  (gj.draggable.methods = {
    init: function (a) {
      var b,
        ...
        d = this.element;
      return (
        gj.widget.prototype.initJS.call(this, a, "draggable"),
        (c = gijgoStorage.get(d, "gijgo")),
        d.setAttribute("data-draggable", "true"),
        (b = gj.draggable.methods.getHandleElement(d, c)),
        b.addEventListener(
          "mousedown",
          gj.draggable.methods.createDownHandle(this, d, c)
        ),
        b.addEventListener(
          "touchstart",
          gj.draggable.methods.createDownHandle(this, d, c)
        ...
        gj.documentManager.subscribeForEvent(
          "mouseup",
          c.guid,
          gj.draggable.methods.createUpHandler(this, d, c)
        ),
        gj.documentManager.subscribeForEvent(
          "touchend",
          c.guid,
    ...
    createDownHandle: function (a, b, c) {
      return function (d) {
        var e = gj.core.position(b);
        (b.style.top = e.top + "px"),
          (b.style.left = e.left + "px"),
          (b.style.position = "fixed"),
          b.setAttribute("draggable-dragging", !0),
          b.removeAttribute("draggable-x"),
          b.removeAttribute("draggable-y"),
          gj.documentManager.subscribeForEvent(
            "touchmove",
            c.guid,
            gj.draggable.methods.createMoveHandler(a, b, c)
          ),
          gj.documentManager.subscribeForEvent(
            "mousemove",
            c.guid,
    ...
    getHandleElement: function (a, b) {
      return b.handle ? b.handle : a;
    },
    createUpHandler: function (a, b, c) {
      return function (d) {
        "true" === b.getAttribute("draggable-dragging") &&
          (b.setAttribute("draggable-dragging", !1),
          gj.documentManager.unsubscribeForEvent("mousemove", c.guid),
          gj.documentManager.unsubscribeForEvent("touchmove", c.guid),
          gj.draggable.events.stop(b, { x: a.mouseX(d), y: a.mouseY(d) }));
      };
    },
    createMoveHandler: function (a, b, c) {
      return function (d) {
        var e, f, g, h, i, j;
        "true" === b.getAttribute("draggable-dragging") &&
          ((e = Math.round(a.mouseX(d))),
          (f = Math.round(a.mouseY(d))),
          (i = b.getAttribute("draggable-x")),
          (j = b.getAttribute("draggable-y")),
          i && j
            ? ((g = c.horizontal ? e - parseInt(i, 10) : 0),
              (h = c.vertical ? f - parseInt(j, 10) : 0),
              gj.draggable.methods.move(b, c, g, h, e, f))
            : gj.draggable.events.start(b, e, f),
          b.setAttribute("draggable-x", e),
          b.setAttribute("draggable-y", f));
      };
    },
    ...
    destroy: function (a) {
      if ("true" === a.getAttribute("data-draggable")) {
        gj.documentManager.unsubscribeForEvent("mouseup", data.guid),
          gijgoStorage.remove(a, "gijgo"),
          a.removeAttribute("data-guid"),
          a.removeAttribute("data-type"),
          a.removeAttribute("data-draggable"),
          a.removeAttribute("draggable-x"),
          a.removeAttribute("draggable-y"),
          a.removeAttribute("draggable-dragging"),
          (a.style.top = ""),
          (a.style.left = ""),
          (a.style.position = ""),
          a.removeEventListener("drag"),
          a.removeEventListener("start"),
          a.removeEventListener("stop");
        var b = gj.draggable.methods.getHandleElement(a, data);
        b.removeEventListener("mousedown"), b.removeEventListener("touchstart");
      }
      return a;
    },
  }),
  (gj.draggable.events = {
    drag: function (a, b, c, d, e) {
      var f = new Event("drag");
      return (
        (f.newPosition = { left: b, top: c }),
        (f.mousePosition = { x: d, y: e }),
        a.dispatchEvent(f)
      );
    },
    start: function (a, b, c) {
      return a.dispatchEvent(new CustomEvent("start", { x: b, y: c }));
    },
    stop: function (a, b) {
      return a.dispatchEvent(new CustomEvent("stop", b));
    },
  }),
  (GijgoDraggable = function (a, b) {
    var c = this,
    ...
    return (
      ...
      "true" !== a.getAttribute("data-draggable") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.draggable = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoDraggable(this[0], null)), b[a]))
              return b[a].apply(
                this[0],
          ...
          return new GijgoDraggable(this[0], a);
        }
      };
    })(jQuery),
  ...
  (GijgoGrid = function (a, b) {
    ...
    return (
      ...
      "grid" !== a.attr("data-type") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.grid = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoGrid(this, null)), b[a]))
              return b[a].apply(this, Array.prototype.slice.call(arguments, 1));
            throw "Method " + a + " does not exist.";
          }
          return new GijgoGrid(this, a);
        }
      };
    })(jQuery),
  ...
  (gj.tree.methods = {
    ...
    appendNode: function (a, b, c, d, e) {
      ...
      if (
        ...
        k.indentation &&
          $wrapper.append(
            $('<span data-role="spacer">').css(
              "width",
              k.indentation * (d - 1) + "px"
            )
          ),
        disabled
  ...
  (GijgoTree = function (a, b) {
    ...
    return (
      ...
      "tree" !== a.attr("data-type") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.tree = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoTree(this, null)), b[a]))
              return b[a].apply(this, Array.prototype.slice.call(arguments, 1));
            throw "Method " + a + " does not exist.";
          }
          return new GijgoTree(this, a);
        }
      };
    })(jQuery),
  ...
  (gj.checkbox.methods = {
    init: function (a) {
      return (
        gj.widget.prototype.initJS.call(this, a, "checkbox"),
        this.element.setAttribute("data-checkbox", "true"),
        gj.checkbox.methods.initialize(
          this,
          gijgoStorage.get(this.element, "gijgo")
        ),
        this
    ...
    initialize: function (a, b) {
      ...
      (c = document.createElement("label")),
        c.classList.add(b.style.wrapperCssClass),
        c.classList.add(b.style.iconsCssClass),
        a.element.getAttribute("id") &&
          c.setAttribute("for", a.element.getAttribute("id")),
        a.element.parentNode.insertBefore(c, a.element),
        c.appendChild(a.element),
        (d = document.createElement("span")),
        b.style.spanCssClass && d.classList.add(b.style.spanCssClass);
    },
    state: function (a, b) {
      return b
        ? ("checked" === b
    ...
    destroy: function (a) {
      ...
      picker.element.parentElement,
        document.body.querySelector(
          '[role="picker"][guid="' +
            picker.element.getAttribute("data-guid") +
            '"]'
        );
      return (
        b &&
          (gijgoStorage.remove(a.element, "gijgo"),
          a.element.removeAttribute("data-type"),
          a.element.removeAttribute("data-guid"),
          a.element.removeAttribute("data-checkbox"),
          a.element.removeAttribute("class"),
          a.next("span").remove(),
          a.unwrap()),
        a
      );
  ...
  (gj.checkbox.events = {
    change: function (a, b) {
      return a.dispatchEvent(new CustomEvent("change", { state: b }));
    },
  }),
  (GijgoCheckBox = function (a, b) {
    var c = this,
    ...
    return (
      ...
      "true" !== a.getAttribute("data-checkbox") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.checkbox = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoCheckBox(this, null)), b[a]))
              return b[a].apply(this, Array.prototype.slice.call(arguments, 1));
            throw "Method " + a + " does not exist.";
          }
          return new GijgoCheckBox(this, a);
        }
      };
    })(jQuery),
  ...
  (gj.editor.methods = {
    init: function (a) {
      return (
        gj.widget.prototype.initJS.call(this, a, "editor"),
        this.element.setAttribute("data-editor", "true"),
        gj.editor.methods.initialize(
          this,
          gijgoStorage.get(this.element, "gijgo")
        ),
        this
    ...
    initialize: function (a, b) {
      ...
      if (
        ...
        "wrapper" !== a.element.parentElement.attributes.role &&
          ((g = document.createElement("div")),
          g.setAttribute("role", "wrapper"),
          a.element.parentNode.insertBefore(g, a.element),
          g.appendChild(a.element)),
        gj.editor.methods.localization(b),
        gj.core.addClasses(g, b.style.wrapper),
        b.width && (g.style.width = b.width),
        (h = g.querySelector('div[role="body"]')),
        h ||
          ((h = document.createElement("div")),
          h.setAttribute("role", "body"),
          g.appendChild(h),
          a.element.innerText && (h.innerHTML = a.element.innerText)),
        h.setAttribute("contenteditable", !0),
        h.addEventListener("keydown", function (b) {
          var c = b.keyCode || b.charCode;
          !1 === gj.editor.events.changing(a.element) &&
            8 !== c &&
            46 !== c &&
            b.preventDefault();
        }),
        h.addEventListener("mouseup keyup mouseout cut paste", function (c) {
          self.updateToolbar(a, i, b),
            gj.editor.events.changed(a),
            a.html(h.html());
        }),
        !(i = g.querySelector('div[role="toolbar"]')))
      ) {
        ...
        for (c in b.buttons) {
          (d = document.createElement("div")),
            d.classList.add(b.style.buttonsGroup);
          for (e in b.buttons[c])
            (f = gj.core.createElement(b.buttons[c][e])),
              f.addEventListener("click", function () {
                gj.editor.methods.executeCmd(a, h, i, this, b);
              }),
              d.appendChild(f);
          i.appendChild(d);
        }
      }
      h.style.height = b.height - gj.core.height(i, !0) + "px";
    },
    localization: function (a) {
    ...
    updateToolbar: function (a, b, c) {
      buttons = b.querySelectorAll("[role]").forEach(function (a) {
        var b = a.getAttribute("role");
        b &&
        document.queryCommandEnabled(b) &&
        "true" === document.queryCommandValue(b)
          ? a.classList.add(c.style.buttonActive)
          : a.classList.remove(c.style.buttonActive);
      });
    },
    executeCmd: function (a, b, c, d, e) {
      b.focus(),
        document.execCommand(d.getAttribute("role"), !1),
        gj.editor.methods.updateToolbar(a, c, e);
    },
    content: function (a, b) {
      var c = a.element.parentElement.querySelector('div[role="body"]');
      if (void 0 === b) return c.innerHTML;
      c.innerHTML = b;
    },
    destroy: function (a) {
      var b;
      return (
        "true" === a.element.getAttribute("data-editor") &&
          ((b = a.element.parentElement),
          b.querySelector('div[role="body"]').remove(),
          b.querySelector('div[role="toolbar"]').remove(),
          (a.element.outerHTML = a.element.innerHTML),
          gijgoStorage.remove(a.element, "gijgo"),
          a.element.removeAttribute("data-guid"),
          a.element.removeAttribute("data-editor"),
          (a.element.display = "block")),
        a
      );
    },
  }),
  (gj.editor.events = {
    changing: function (a) {
      return a.dispatchEvent(new Event("changing"));
    },
    changed: function (a) {
      return a.dispatchEvent(new Event("changed"));
    },
  }),
  (GijgoEditor = function (a, b) {
    var c = this,
      d = gj.editor.methods;
    return (
      (c.element = a),
      ...
      "true" !== a.getAttribute("data-editor") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.editor = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoEditor(this, null)), b[a]))
              return b[a].apply(this, Array.prototype.slice.call(arguments, 1));
            throw "Method " + a + " does not exist.";
          }
          return new GijgoEditor(this, a);
        }
      };
    })(jQuery),
  ...
  (GijgoDropDown = function (a, b) {
    ...
    return (
      ...
      "true" !== a.attr("data-dropdown") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.dropdown = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoDropDown(this, null)), b[a]))
              return b[a].apply(this, Array.prototype.slice.call(arguments, 1));
            throw "Method " + a + " does not exist.";
          }
          return new GijgoDropDown(this, a);
        }
      };
    })(jQuery),
  ...
  (gj.datepicker.methods = {
    init: function (a) {
      return (
        gj.widget.prototype.initJS.call(this, a, "datepicker"),
        this.element.setAttribute("data-datepicker", "true"),
        gj.datepicker.methods.initialize(
          this,
          gijgoStorage.get(this.element, "gijgo")
        ),
        this
    ...
    initialize: function (a, b) {
      ...
      "wrapper" !== a.element.parentElement.attributes.role
        ? ((c = document.createElement("div")),
          ...
          a.element.parentNode.insertBefore(c, a.element),
          c.appendChild(a.element))
        : (c = a.element.parentElement),
        gj.core.addClasses(c, b.style.wrapper),
        b.width && (c.style.width = b.width + "px"),
        (a.element.value = b.value || ""),
        gj.core.addClasses(a.element, b.style.input),
        c.setAttribute("role", "input"),
        b.fontSize && (a.element.style.fontSize = b.fontSize),
        "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary
          ? "small" === b.size
            ? (c.classList.add("input-group-sm"),
              a.element.classList.add("form-control-sm"))
            : "large" === b.size &&
              (c.classList.add("input-group-lg"),
              a.element.classList.add("form-control-lg"))
          : "small" === b.size
          ? c.classList.add("small")
          : "large" === b.size && c.classList.add("large"),
        b.showRightIcon &&
          ("bootstrap" === b.uiLibrary
            ? ((d = document.createElement("span")),
              d.classList.add("input-group-addon"),
          ...
          d.addEventListener("click", function (c) {
            var d = document.body.querySelector(
              '[role="picker"][guid="' +
                a.element.getAttribute("data-guid") +
                '"]'
            );
          ...
          c.appendChild(d)),
        b.showOnFocus &&
          a.element.addEventListener("focus", function () {
            gj.datepicker.methods.open(a, b);
          }),
        (e = gj.datepicker.methods.createCalendar(a, b)),
        !0 !== b.footer &&
          (a.element.addEventListener("blur", function () {
            a.timeout = setTimeout(function () {
              gj.datepicker.methods.close(a);
            }, 500);
          }),
          e.addEventListener("mousedown", function () {
            return (
              clearTimeout(a.timeout),
              document.activeElement !== a.element && a.element.focus(),
              !1
            );
          }),
        ...
        b.keyboardNavigation &&
          document.addEventListener(
            "keydown",
            gj.datepicker.methods.createKeyDownHandler(a, e, b)
          );
    },
    createCalendar: function (a, b) {
      ...
      return (
        (h = document.createElement("div")),
        h.setAttribute("role", "picker"),
        h.setAttribute("type", "month"),
        gj.core.addClasses(h, b.style.calendar),
        h.setAttribute("guid", a.element.getAttribute("data-guid")),
        b.fontSize && (h.style.fontSize = b.fontSize),
        ...
        h.setAttribute("month", c.getMonth()),
        h.setAttribute("year", c.getFullYear()),
        ...
        b.footer &&
          ((e = document.createElement("div")),
          e.setAttribute("role", "footer"),
          gj.core.addClasses(e, b.style.footer),
          (f = gj.core.createElement(
            '<button class="' +
              b.style.button +
              '">' +
            ...
            e
              ? ((d = e.split("-")),
                (c = new Date(
                  ...
                  d[1],
                  d[2],
                  h.getAttribute("hour") || 0,
                  h.getAttribute("minute") || 0
                )),
        ...
        b.modal &&
          ((i = document.createElement("div")),
          i.setAttribute("role", "modal"),
          gj.core.addClasses(i, b.style.modal),
          h.parentNode.insertBefore(i, h),
          i.appendChild(h),
          gj.core.center(h)),
        h
    ...
    renderHeader: function (a, b, c, d) {
      ...
      c.header &&
        ((e = document.createElement("div")),
        e.setAttribute("role", "header"),
        (g = document.createElement("div")),
        g.setAttribute("role", "year"),
        g.addEventListener("click", function () {
          gj.datepicker.methods.renderDecade(a, b, c),
            g.classList.add("selected"),
            f.classList.remove("selected");
        }),
        (g.innerHTML = gj.core.formatDate(d, "yyyy", c.locale)),
        e.appendChild(g),
        (f = document.createElement("div")),
        f.setAttribute("role", "date"),
        ...
        (f.innerHTML = gj.core.formatDate(d, "ddd, mmm dd", c.locale)),
        e.appendChild(f),
        b.appendChild(e));
    },
    updateHeader: function (a, b, c) {
      var d,
        ...
        f,
        g,
        h = a.querySelector('[role="header"]');
      h &&
        ((d = h.querySelector('[role="year"]')),
        d &&
          (d.classList.remove("selected"),
          (d.innerHTML = gj.core.formatDate(c, "yyyy", b.locale))),
        (e = h.querySelector('[role="date"]')),
        e.classList.add("selected"),
        (e.innerHTML = gj.core.formatDate(c, "ddd, mmm dd", b.locale)),
        (f = h.querySelector('[role="hour"]')),
        f &&
          (f.classList.remove("selected"),
          (f.innerHTML = gj.core.formatDate(c, "HH", b.locale))),
        (g = h.querySelector('[role="minute"]')) &&
          (g.classList.remove("selected"),
          (g.innerHTML = gj.core.formatDate(c, "MM", b.locale))));
    },
    createNavigation: function (a, b, c, d) {
      ...
      for (
        e = document.createElement("div"),
          e.setAttribute("role", "navigator"),
          g = document.createElement("div"),
          g.innerHTML = d.icons.previousMonth,
          g.addEventListener("click", gj.datepicker.methods.prev(a, d)),
          e.appendChild(g),
          h = document.createElement("div"),
          h.setAttribute("role", "period"),
          h.addEventListener("click", gj.datepicker.methods.changePeriod(a, d)),
          e.appendChild(h),
          j = document.createElement("div"),
          j.innerHTML = d.icons.nextMonth,
          j.addEventListener("click", gj.datepicker.methods.next(a, d)),
          e.appendChild(j),
          b.append(e),
          f = document.createElement("tr"),
          f.setAttribute("role", "week-days"),
          d.calendarWeeks &&
        ...
        (k = document.createElement("th")),
          (k.innerHTML =
            "<div>" + gj.core.messages[d.locale].weekDaysMin[i] + "</div>"),
          f.appendChild(k);
    ...
    renderMonth: function (a, b, c) {
      ...
      for (
        s.innerHTML = "",
          ...
          g = parseInt(b.getAttribute("month"), 10),
          h = parseInt(b.getAttribute("year"), 10),
          b.setAttribute("type", "month"),
          v = v
            .replace("mmmm", gj.core.messages[c.locale].monthNames[g])
            .replace("yyyy", h),
          b.querySelector('div[role="period"]').innerText = v,
          j = gj.datepicker.methods.getDaysInMonth(h),
          i = j[g],
        ...
        (f = j[n.month] - k + l),
          ...
          c.calendarWeeks &&
            ...
            p.classList.add("calendar-week"),
            (p.innerHTML =
              "<div>" + gj.datepicker.methods.getWeekNumber(r) + "</div>"),
            row.appendChild(p)),
          (p = document.createElement("td")),
          p.classList.add("other-month"),
          c.showOtherMonths &&
            ((q = document.createElement("div")),
            (q.innerHTML = f),
            p.appendChild(q),
            c.selectOtherMonths && gj.datepicker.methods.isSelectable(c, r)
              ? (p.classList.add("gj-cursor-pointer"),
                p.setAttribute("day", f),
                p.setAttribute("month", n.month),
                p.setAttribute("year", n.year),
                q.addEventListener(
                  "click",
          ...
          row.appendChild(p),
          d++;
      for (l > 1 && u.appendChild(row), m = new Date(), l = 1; l <= i; l++)
        (r = new Date(h, g, l)),
          0 == d &&
            ((row = document.createElement("tr")),
            c.calendarWeeks &&
              ...
              row.appendChild(p))),
          (p = document.createElement("td")),
          p.setAttribute("day", l),
          p.setAttribute("month", g),
          p.setAttribute("year", h),
          h === m.getFullYear() && g === m.getMonth() && l === m.getDate()
            ? p.classList.add("today")
            : p.classList.add("current-month"),
          (q = document.createElement("div")),
          (q.innerText = l),
        ...
        (r = new Date(o.year, o.month, l)),
          ...
          c.showOtherMonths &&
            ...
            c.selectOtherMonths && gj.datepicker.methods.isSelectable(c, r)
              ? (p.classList.add("gj-cursor-pointer"),
                p.setAttribute("day", l),
                p.setAttribute("month", o.month),
                p.setAttribute("year", o.year),
                q.addEventListener(
                  "click",
                  gj.datepicker.methods.dayClickHandler(a, b, c, r)
                ),
      ...
      t.appendChild(u),
        s.appendChild(t),
        b.getAttribute("selectedDay") &&
          ((e = b.getAttribute("selectedDay").split("-")),
          (r = new Date(
            e[0],
            e[1],
            e[2],
            b.getAttribute("hour") || 0,
            b.getAttribute("minute") || 0
          )),
          (p = b.querySelector(
            'tbody td[day="' + e[2] + '"][month="' + e[1] + '"]'
          )),
    ...
    renderYear: function (a, b, c) {
      var d,
        ...
        g,
        h,
        i = b.querySelector('[role="body"] table'),
        j = i.querySelector("tbody");
      for (
        i.querySelector("thead").style.display = "none",
          d = parseInt(b.getAttribute("year"), 10),
          b.setAttribute("type", "year"),
          b.querySelector('div[role="period"]').innerText = d,
          j.innerHTML = "",
          e = 0;
        e < 3;
        e++
      ) {
        for (g = document.createElement("tr"), f = 4 * e; f <= 4 * e + 3; f++)
          (h = document.createElement("div")),
            (h.innerHTML = gj.core.messages[c.locale].monthShortNames[f]),
            h.addEventListener(
              "click",
              gj.datepicker.methods.selectMonth(a, b, c, f)
            ),
    ...
    renderDecade: function (a, b, c) {
      var d,
        ...
        g,
        d,
        h = b.querySelector('[role="body"] table'),
        i = h.querySelector("tbody");
      for (
        h.querySelector("thead").display.style = "none",
          d = parseInt(b.getAttribute("year"), 10),
          e = d - (d % 10),
          b.setAttribute("type", "decade"),
          b.querySelector('div[role="period"]').innerText = e + " - " + (e + 9),
          i.innerHTML = "",
          f = e - 1;
        f <= e + 10;
        f += 4
      ) {
        for (row = document.createElement("tr"), g = f; g <= f + 3; g++)
          (d = document.createElement("div")),
            (d.innerText = g),
            d.addEventListener(
              "click",
              gj.datepicker.methods.selectYear(a, b, c, g)
            ),
            (cell = document.createElement("td")),
            cell.appendChild(d),
    ...
    renderCentury: function (a, b, c) {
      var d,
        ...
        h,
        i = b.querySelector('[role="body"] table'),
        j = $table.querySelector("tbody");
      for (
        i.querySelector("thead").style.display = "none",
          d = parseInt(b.getAttribute("year"), 10),
          e = d - (d % 100),
          b.setAttribute("type", "century"),
          b.querySelector('div[role="period"]').innerText =
            e + " - " + (e + 99),
          j.innerHTML = "",
          f = e - 10;
        f < e + 100;
        ...
        for (row = document.createElement("tr"), g = f; g <= f + 30; g += 10)
          (h = document.createElement("div")),
            (h.innerText = g),
            h.addEventListener(
              "click",
              gj.datepicker.methods.selectDecade(a, b, c, g)
            ),
            (cell = document.createElement("td")),
            cell.appendChild(h),
            row.appendChild(cell);
    ...
    isSelectable: function (a, b) {
      ...
      if ((e && b < e ? (d = !1) : f && b > f && (d = !1), d)) {
        if (a.disableDates)
          if (Array.isArray(a.disableDates))
        ...
        Array.isArray(a.disableDaysOfWeek) &&
    ...
    prev: function (a, b) {
      return function () {
        ...
        switch (
          ((e = parseInt(h.getAttribute("year"), 10)), h.getAttribute("type"))
        ) {
          case "month":
            (d = parseInt(h.getAttribute("month"), 10)),
              (c = gj.datepicker.methods.getPrevMonth(d, e)),
              h.setAttribute("month", c.month),
              h.setAttribute("year", c.year),
              gj.datepicker.methods.renderMonth(a, h, b);
            break;
          case "year":
            h.setAttribute("year", e - 1),
              gj.datepicker.methods.renderYear(a, h, b);
            break;
          case "decade":
            (f = e - (e % 10)),
              h.setAttribute("year", f - 10),
              gj.datepicker.methods.renderDecade(a, h, b);
            break;
          case "century":
            (g = e - (e % 100)),
              h.setAttribute("year", g - 100),
    ...
    next: function (a, b) {
      return function (c) {
        ...
        switch (
          ((f = parseInt(i.getAttribute("year"), 10)), i.getAttribute("type"))
        ) {
          case "month":
            (e = parseInt(i.getAttribute("month"), 10)),
              (d = gj.datepicker.methods.getNextMonth(e, f)),
              i.setAttribute("month", d.month),
              i.setAttribute("year", d.year),
              gj.datepicker.methods.renderMonth(a, i, b);
            break;
          case "year":
            i.setAttribute("year", f + 1),
              gj.datepicker.methods.renderYear(a, i, b);
            break;
          case "decade":
            (g = f - (f % 10)),
              i.setAttribute("year", g + 10),
              gj.datepicker.methods.renderDecade(a, i, b);
            break;
          case "century":
            (h = f - (f % 100)),
              i.setAttribute("year", h + 100),
              gj.datepicker.methods.renderCentury(a, i, b);
        }
        return !1;
      };
    },
    changePeriod: function (a, b) {
      return function (c) {
        var d = document.body.querySelector(
          '[role="picker"][guid="' + a.element.getAttribute("data-guid") + '"]'
        );
    ...
    dayClickHandler: function (a, b, c, d) {
      return function (e) {
        return (
          ...
          gj.datepicker.events.select(a.element, "day"),
          !0 !== c.footer &&
            !1 !== c.autoClose &&
    ...
    change: function (a, b, c, d) {
      ...
      b.setAttribute("month", e),
        b.setAttribute("year", f),
        (a.element.value = g),
        gj.datepicker.events.change(a.element),
        "none" !== window.getComputedStyle(b).display &&
          gj.datepicker.methods.close(a);
    },
    selectDay: function (a, b, c, d) {
      var e,
        ...
        g = d.getMonth(),
        h = d.getFullYear();
      b.setAttribute("selectedDay", h + "-" + g + "-" + f),
        [].forEach.call(b.querySelectorAll("tbody td"), function (a) {
          a.classList.remove("selected");
        }),
        (e = b.querySelector('tbody td[day="' + f + '"][month="' + g + '"]')),
        e && e.classList.add("selected"),
        gj.datepicker.methods.updateHeader(b, c, d);
    },
    selectMonth: function (a, b, c, d) {
      return function (e) {
        b.setAttribute("month", d),
          gj.datepicker.methods.renderMonth(a, b, c),
          gj.datepicker.events.select(a.element, "month");
      };
    },
    selectYear: function (a, b, c, d) {
      return function (e) {
        b.setAttribute("year", d),
          gj.datepicker.methods.renderYear(a, b, c),
          gj.datepicker.events.select(a.element, "year");
      };
    },
    selectDecade: function (a, b, c, d) {
      return function (e) {
        b.setAttribute("year", d),
          gj.datepicker.methods.renderDecade(a, b, c),
          gj.datepicker.events.select(a.element, "decade");
      };
    },
    open: function (a, b) {
      var c,
      ...
      if ("none" === window.getComputedStyle(d).display) {
        switch (
          (a.element.value
            ? a.value(a.element.value)
            : ((c = new Date()),
              d.setAttribute("month", c.getMonth()),
              d.setAttribute("year", c.getFullYear())),
          d.getAttribute("type"))
        ) {
          case "year":
            gj.datepicker.methods.renderYear(a, d, b);
        ...
        (d.style.display = "block"),
          b.modal
            ? ((d.parentElement.style.display = "block"), gj.core.center(d))
            : (gj.core.setChildPosition(a.element, d),
              document.activeElement !== a.element && a.element.focus()),
          clearTimeout(a.timeout),
          gj.datepicker.events.open(a.element);
      }
    },
    close: function (a) {
      ...
      "none" !== window.getComputedStyle(b).display &&
        ...
        "modal" === b.parentElement.getAttribute("role") &&
          (b.parentElement.style.display = "none"),
        gj.datepicker.events.close(a.element));
    },
    createKeyDownHandler: function (a, b, c) {
      return function (d) {
        ...
        (d = d || window.event),
          "none" !== window.getComputedStyle(b).display &&
            ((e = gj.datepicker.methods.getActiveCell(b)),
            gj.datepicker.methods.activateNextElement(a, b, c, d.keyCode, e));
      };
    },
    activateNextElement: function (a, b, c, d, e) {
      var f, g, h, i, j;
      "38" == d
        ? ((i = Array.prototype.slice
          ...
          e.parentElement.previousSibling &&
            (j = e.parentElement.previousSibling.children[i]),
          (j && j.hasAttribute("day")) ||
            (gj.datepicker.methods.prev(a, c)(),
            (nodes = b.querySelectorAll("tbody tr")),
            (j = nodes[nodes.length - 1].querySelectorAll("td")[i])),
          gj.datepicker.methods.selectElement(a, b, c, d, e, j))
        : "40" == d
        ? ((i = Array.prototype.slice
            .call(e.parentElement.children)
            .indexOf(e)),
          e.parentElement.nextSibling &&
            (j = e.parentElement.nextSibling.children[i]),
          (j && j.hasAttribute("day")) ||
            (gj.datepicker.methods.next(a, c)(),
            (j = b.querySelector("tbody tr").querySelectorAll("td")[i])),
          gj.datepicker.methods.selectElement(a, b, c, d, e, j))
        : "37" == d
        ? ((j = e.previousSibling),
          !j &&
            e.parentElement.previousSibling &&
            e.parentElement.previousSibling.children[6].hasAttribute("day") &&
            (j = e.parentElement.previousSibling.children[6]),
          j ||
            (gj.datepicker.methods.prev(a, c)(),
            (g = parseInt(b.getAttribute("month"), 10)),
            (h = parseInt(b.getAttribute("year"), 10)),
            (f = c.showOtherMonths
              ? parseInt(e.getAttribute("day"), 10) - 1
              : gj.datepicker.methods.getDaysInMonth(h)[g]),
            (j = b.querySelector('tbody tr td[day="' + f + '"]'))),
          gj.datepicker.methods.selectElement(a, b, c, d, e, j))
        : "39" == d
        ? ((j = e.nextSibling),
          !j &&
            e.parentElement.nextSibling &&
            e.parentElement.nextSibling.children[0].hasAttribute("day") &&
            (j = e.parentElement.nextSibling.children[0]),
          j ||
            (gj.datepicker.methods.next(a, c)(),
            (f = c.showOtherMonths
              ? parseInt(e.getAttribute("day"), 10) + 1
          ...
          gj.datepicker.methods.selectElement(a, b, c, d, e, j))
        : "13" == d
        ? ((f = parseInt(e.getAttribute("day"), 10)),
          (g = parseInt(e.getAttribute("month"), 10)),
          (h = parseInt(e.getAttribute("year"), 10)),
          gj.datepicker.methods.dayClickHandler(a, b, c, new Date(h, g, f))())
        : "27" == d && a.close();
    },
    selectElement: function (a, b, c, d, e, f) {
      f &&
        (f.classList.contains("disabled") || !f.hasAttribute("day")
          ? (e.classList.remove("focused"),
            gj.datepicker.methods.activateNextElement(a, b, c, d, f))
          : (f.classList.add("focused"), e.classList.remove("focused")));
    },
    getActiveCell: function (a) {
      var b = a.querySelector("td[day].focused");
      return (
        b ||
          (b = a.querySelector("td[day].selected")) ||
          (b = a.querySelector("td[day].today")) ||
          (b = a.querySelector("td[day]:not(.disabled)")),
        b
      );
    },
    value: function (a, b) {
      var c,
        d,
        e = gijgoStorage.get(a.element, "gijgo");
      return void 0 === b
        ? a.element.value
    ...
    destroy: function (a) {
      ...
      return (
        b &&
          ("modal" === a.element.parentElement.getAttribute("role") &&
            (a.element.outerHTML = a.element.innerHTML),
          gijgoStorage.remove(a.element, "gijgo"),
          a.element.removeAttribute("data-type"),
          a.element.removeAttribute("data-guid"),
          a.element.removeAttribute("data-datepicker"),
          a.element.removeAttribute("class"),
          a.element.removeChild(
            a.element.querySelector('[role="right-icon"]')
          )),
        a
      );
    },
  ...
  (gj.datepicker.events = {
    change: function (a) {
      return a.dispatchEvent(new Event("change"));
    },
    select: function (a, b) {
      return a.dispatchEvent(
        new CustomEvent("select", { detail: { type: b } })
      );
    },
    open: function (a) {
      return a.dispatchEvent(new Event("open"));
    },
    close: function (a) {
      return a.dispatchEvent(new Event("close"));
    },
  }),
  (GijgoDatePicker = function (a, b) {
    var c = this,
      d = gj.datepicker.methods;
    return (
      (c.element = a),
      ...
      "true" !== a.getAttribute("data-datepicker") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.datepicker = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoDatePicker(this[0], null)), b[a]))
              return b[a].apply(
                this[0],
                Array.prototype.slice.call(arguments, 1)
              );
          ...
          return new GijgoDatePicker(this[0], a);
        }
      };
    })(jQuery),
  ...
  (gj.timepicker.methods = {
    ...
    initialize: function () {},
    initMouse: function (a, b, c) {
      var d = b.querySelector('[role="body"]');
      d.addEventListener(
        "mousedown",
        gj.timepicker.methods.mouseDownHandler(b)
      ),
        d.addEventListener(
          "mousemove",
          gj.timepicker.methods.mouseMoveHandler(a, b, c)
        ),
        d.addEventListener(
          "mouseup",
          gj.timepicker.methods.mouseUpHandler(a, b, c)
        );
    },
    createPopup: function (a) {
      var b,
        ...
        d,
        e,
        f = gijgoStorage.get(a.element, "gijgo"),
        g = document.createElement("div"),
        h = document.createElement("div"),
      ...
      return (
        gj.core.addClasses(g, f.style.clock),
        g.setAttribute("role", "picker"),
        g.setAttribute("guid", a.element.getAttribute("data-guid")),
        h.setAttribute("role", "hour"),
        j.setAttribute("role", "minute"),
        k.setAttribute("role", "header"),
        l.setAttribute("role", "mode"),
        m.setAttribute("role", "body"),
        gj.core.addClasses(n, f.style.button),
        (n.innerText = gj.core.messages[f.locale].ok),
        gj.core.addClasses(o, f.style.button),
        (o.innerText = gj.core.messages[f.locale].cancel),
        p.setAttribute("role", "footer"),
        gj.core.addClasses(p, f.style.footer),
        (b = gj.core.parseDate(f.value, f.format, f.locale)),
        !b || isNaN(b.getTime())
          ? (b = new Date())
          : a.element.setAttribute("hours", b.getHours()),
        f.header &&
          (h.addEventListener("click", function () {
            gj.timepicker.methods.renderHours(a.element, g, f);
          }),
          j.addEventListener("click", function () {
            gj.timepicker.methods.renderMinutes(a.element, g, f);
          }),
          k.appendChild(h),
          (i.innerText = ":"),
          k.appendChild(i),
          ...
          "ampm" === f.mode &&
            ...
            c.setAttribute("role", "am"),
            (c.innerText = gj.core.messages[f.locale].am),
            l.appendChild(c),
            c.addEventListener("click", function () {
              var b = gj.timepicker.methods.getHour(g);
              g.setAttribute("mode", "am"),
                this.classList.add("selected"),
                this.parentElement
                  .querySelector('[role="pm"]')
                  .classList.remove("selected"),
                b >= 12 && g.setAttribute("hour", b - 12),
                f.modal || (clearTimeout(a.timeout), a.element.focus());
            }),
            l.appendChild(document.createElement("br")),
            (d = document.createElement("span")),
            d.setAttribute("role", "pm"),
            (d.innerText = gj.core.messages[f.locale].pm),
            l.appendChild(d),
            d.addEventListener("click", function () {
              var b = gj.timepicker.methods.getHour(g);
              g.setAttribute("mode", "pm"),
                this.classList.add("selected"),
                this.parentElement
                  .querySelector('[role="am"]')
                  .classList.remove("selected"),
                b < 12 && g.setAttribute("hour", b + 12),
                f.modal || (clearTimeout(a.timeout), a.element.focus());
            }),
        ...
        f.footer &&
          ...
          p.appendChild(o),
          n.addEventListener("click", gj.timepicker.methods.setTime(a, g)),
          p.appendChild(n),
          g.appendChild(p)),
        ...
        f.modal &&
          ((e = document.createElement("div")),
          e.setAttribute("role", "modal"),
          gj.core.addClasses(e, f.style.modal),
          g.parentNode.insertBefore(e, g),
          e.appendChild(g),
          gj.core.center(g)),
        gj.timepicker.methods.initMouse(a, g, f),
        g
      );
    },
    getHour: function (a) {
      return parseInt(a.getAttribute("hour"), 10) || 0;
    },
    getMinute: function (a) {
      return parseInt(a.getAttribute("minute"), 10) || 0;
    },
    setTime: function (a, b) {
      return function () {
        var c = gj.timepicker.methods.getHour(b),
          d = gj.timepicker.methods.getMinute(b),
          e = b.getAttribute("mode"),
          f = new Date(0, 0, 0, 12 === c && "am" === e ? 0 : c, d),
          g = gijgoStorage.get(a.element, "gijgo"),
    ...
    updateArrow: function (a, b, c, d) {
      var e,
        ...
        h = b.mouseX(a),
        i = b.mouseY(a),
        j = window.scrollY || window.pageYOffset || 0,
        k = window.scrollX || window.pageXOffset || 0;
      (e = a.target.getBoundingClientRect()),
        ...
        "hours" === f
          ? ((g = gj.timepicker.methods.getPointerValue(
            ...
            c.setAttribute(
              "hour",
              "ampm" === d.mode && "pm" === c.getAttribute("mode") && g < 12
                ? g + 12
                : g
            ))
          : "minutes" === f &&
    ...
    update: function (a, b, c) {
      ...
      for (
        d = gj.timepicker.methods.getHour(b),
          ...
          f = b.querySelector('[role="arrow"]'),
          g = b.getAttribute("type"),
          "hours" === g && (0 == d || d > 12) && "24hr" === c.mode
            ? (f.style.width = "calc(50% - 52px)")
            : (f.style.width = "calc(50% - 20px)"),
          f.style.transform =
            "hours" === g
              ? "rotate(" + (30 * d - 90).toString() + "deg)"
              : "rotate(" + (6 * e - 90).toString() + "deg)",
          f.style.display = "block",
          h = "ampm" === c.mode && d > 12 ? d - 12 : 0 == d ? 12 : d,
          j = b.querySelectorAll('[role="body"] span'),
          k = 0;
        k < j.length;
        k++
      )
        (l = parseInt(j[k].innerText, 10)),
          "hours" === g && l === h
            ? j[k].classList.add("selected")
            : "minutes" === g && l === e
            ? j[k].classList.add("selected")
            : j[k].classList.remove("selected");
      c.header &&
        ((i = b.querySelector('[role="header"]')),
        (i.querySelector('[role="hour"]').innerText = h),
        (i.querySelector('[role="minute"]').innerText = gj.core.pad(e)),
        "ampm" === c.mode &&
          (d >= 12
            ? (i.querySelector('[role="pm"]').classList.add("selected"),
              i.querySelector('[role="am"]').classList.remove("selected"))
            : (i.querySelector('[role="am"]').classList.add("selected"),
              i.querySelector('[role="pm"]').classList.remove("selected"))));
    },
    ...
    mouseUpHandler: function (a, b, c) {
      return function (d) {
        ...
        ("hours" !== e && "minutes" !== e) ||
          ...
          (a.mouseMove = !1),
          c.modal || (clearTimeout(a.timeout), a.element.focus()),
          "hours" === e
            ? setTimeout(function () {
                gj.timepicker.events.select(a.element, "hour"),
            ...
            : "minutes" === e &&
              ...
              gj.timepicker.events.select(a.element, "minute")));
      };
    },
    renderHours: function (a, b, c) {
      var d,
        e,
        f = b.querySelector('[role="body"]');
      clearTimeout(a.timeout),
        (f.innerHTML = ""),
        (d = document.createElement("div")),
        d.setAttribute("role", "dial"),
        (e = gj.core.createElement(
          '<div role="arrow" style="display: none; transform: rotate(-90deg);" />'
        )),
        e.appendChild(gj.core.createElement('<div class="arrow-begin"></div>')),
        e.appendChild(gj.core.createElement('<div class="arrow-end"></div>')),
        d.appendChild(e),
        d.appendChild(
          gj.core.createElement(
        ...
        c.header &&
          (b
            .querySelector('[role="header"] [role="hour"]')
            .classList.add("selected"),
          b
            .querySelector('[role="header"] [role="minute"]')
            .classList.remove("selected")),
        b.setAttribute("type", "hours"),
        gj.timepicker.methods.update(a, b, c);
    },
    renderMinutes: function (a, b, c) {
      var d,
        e = b.querySelector('[role="body"]');
      clearTimeout(a.timeout),
        (e.innerHTML = ""),
        (dial = document.createElement("div")),
        dial.setAttribute("role", "dial"),
        (d = document.createElement("div")),
        d.setAttribute("role", "arrow"),
        (d.style.display = "none"),
        (d.style.transform = "rotate(-90deg)"),
        d.appendChild(gj.core.createElement('<div class="arrow-begin"></div>')),
        d.appendChild(gj.core.createElement('<div class="arrow-end"></div>')),
        dial.appendChild(d),
        dial.appendChild(
          gj.core.createElement(
            '<span role="hour" style="transform: translate(54px, -93.5307px)">5</span>'
        ...
        c.header &&
          ...
          b
            .querySelector('[role="header"] [role="minute"]')
            .classList.add("selected")),
        b.setAttribute("type", "minutes"),
        gj.timepicker.methods.update(a, b, c);
    },
    setAttributes: function (a, b, c) {
      var d = c.getHours();
      "ampm" === b.mode && a.setAttribute("mode", d > 12 ? "pm" : "am"),
        a.setAttribute("hour", d),
        a.setAttribute("minute", c.getMinutes());
    },
    open: function (a) {
      var b,
        c = gijgoStorage.get(a.element, "gijgo"),
        d = document.body.querySelector(
          '[role="picker"][guid="' + a.element.getAttribute("data-guid") + '"]'
        );
      return (
        (b = a.value()
          ? gj.core.parseDate(a.value(), c.format, c.locale)
          : new Date()),
        gj.timepicker.methods.setAttributes(d, c, b),
    ...
    value: function (a, b) {
      return void 0 === b
        ? a.element.value
        : ((a.element.value = b), gj.timepicker.events.change(a.element), a);
    },
  }),
  ...
  (GijgoTimePicker = function (a, b) {
    ...
    return (
      ...
      "true" !== a.getAttribute("data-timepicker") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.timepicker = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoTimePicker(this[0], null)), b[a]))
              return b[a].apply(
                this[0],
                Array.prototype.slice.call(arguments, 1)
              );
          ...
          return new GijgoTimePicker(this[0], a);
        }
      };
    })(jQuery),
  ...
  (gj.datetimepicker.methods = {
    init: function (a) {
      return (
        gj.widget.prototype.initJS.call(this, a, "datetimepicker"),
        this.element.setAttribute("data-datetimepicker", "true"),
        gj.datetimepicker.methods.initialize(
          this,
          gijgoStorage.get(this.element, "gijgo")
        ),
        this
    ...
    getConfig: function (a, b) {
      var c = gj.widget.prototype.getConfigJS.call(this, a, b);
      return (
        (uiLibrary = a.hasOwnProperty("uiLibrary") ? a.uiLibrary : c.uiLibrary),
        gj.datepicker.config[uiLibrary] &&
          this.extend(c.datepicker, gj.datepicker.config[uiLibrary]),
        gj.timepicker.config[uiLibrary] &&
          this.extend(c.timepicker, gj.timepicker.config[uiLibrary]),
        (iconsLibrary = a.hasOwnProperty("iconsLibrary")
          ? a.iconsLibrary
          : c.iconsLibrary),
        gj.datepicker.config[iconsLibrary] &&
          this.extend(c.datepicker, gj.datepicker.config[iconsLibrary]),
        gj.timepicker.config[iconsLibrary] &&
          this.extend(c.timepicker, gj.timepicker.config[iconsLibrary]),
        c
      );
    },
    initialize: function (a, b) {
      var c, d, e, f, g, h, i, j, k, l, m;
      (b.datepicker.uiLibrary = b.uiLibrary),
        (b.datepicker.iconsLibrary = b.iconsLibrary),
        (b.datepicker.width = b.width),
        (b.datepicker.format = b.format),
        (b.datepicker.locale = b.locale),
        (b.datepicker.modal = b.modal),
        (b.datepicker.footer = b.footer),
        (b.datepicker.style.calendar = b.style.calendar),
        (b.datepicker.value = b.value),
        (b.datepicker.size = b.size),
        (b.datepicker.autoClose = !1),
        gj.datepicker.methods.initialize(a, b.datepicker),
        (m = document.body.querySelector(
          '[role="picker"][guid="' + a.element.getAttribute("data-guid") + '"]'
        )),
        a.element.addEventListener("select", function (c) {
          var d, e, f;
          "day" === c.detail.type
            ? gj.datetimepicker.methods.createShowHourHandler(a, m, b)()
            : "minute" === c.detail.type &&
              m.getAttribute("selectedDay") &&
              !0 !== b.footer &&
              ((d = m.getAttribute("selectedDay").split("-")),
              (e = new Date(
                d[0],
                d[1],
                d[2],
                m.getAttribute("hour") || 0,
                m.getAttribute("minute") || 0
              )),
              (f = gj.core.formatDate(e, b.format, b.locale)),
              (a.element.value = f),
              gj.datetimepicker.events.change(a.element),
              gj.datetimepicker.methods.close(a));
        }),
        a.element.addEventListener("open", function () {
          var a = m.querySelector('[role="header"]');
          a.querySelector('[role="calendarMode"]').classList.add("selected"),
            a.querySelector('[role="clockMode"]').classList.remove("selected");
        }),
        (c = b.value
          ? gj.core.parseDate(b.value, b.format, b.locale)
          : new Date()),
        m.setAttribute("hour", c.getHours()),
        m.setAttribute("minute", c.getMinutes()),
        (b.timepicker.uiLibrary = b.uiLibrary),
        (b.timepicker.iconsLibrary = b.iconsLibrary),
        (b.timepicker.format = b.format),
        (b.timepicker.locale = b.locale),
        (b.timepicker.header = !0),
        (b.timepicker.footer = b.footer),
        (b.timepicker.size = b.size),
        (b.timepicker.mode = "24hr"),
        (b.timepicker.autoClose = !1),
        gj.timepicker.methods.initMouse(a, m, b.timepicker),
        (d = document.createElement("div")),
        d.setAttribute("role", "header"),
        (e = document.createElement("div")),
        e.setAttribute("role", "date"),
        e.classList.add("selected"),
        e.addEventListener(
          "click",
          gj.datetimepicker.methods.createShowDateHandler(a, m, b)
        ),
        (e.innerHTML = gj.core.formatDate(new Date(), "ddd, mmm dd", b.locale)),
        d.appendChild(e),
        (f = document.createElement("div")),
        f.setAttribute("role", "switch"),
        (k = document.createElement("i")),
        k.classList.add("gj-icon"),
        k.classList.add("selected"),
        k.setAttribute("role", "calendarMode"),
        (k.innerHTML = "event"),
        k.addEventListener(
          "click",
          gj.datetimepicker.methods.createShowDateHandler(a, m, b)
        ...
        (h.innerHTML = gj.core.formatDate(new Date(), "HH", b.locale)),
        (i = document.createElement("div")),
        (i.innerText = ":"),
        (j = document.createElement("div")),
        j.setAttribute("role", "minute"),
        j.addEventListener(
          "click",
          gj.datetimepicker.methods.createShowMinuteHandler(a, m, b)
        ),
        (j.innerHTML = gj.core.formatDate(new Date(), "MM", b.locale)),
        g.appendChild(h),
        g.appendChild(i),
        g.appendChild(j),
        f.appendChild(g),
        (l = document.createElement("i")),
        l.classList.add("gj-icon"),
        l.setAttribute("role", "clockMode"),
        (l.innerHTML = "clock"),
        l.addEventListener(
          "click",
          gj.datetimepicker.methods.createShowHourHandler(a, m, b)
    ...
    createShowDateHandler: function (a, b, c) {
      return function () {
        var d = b.querySelector('[role="header"]');
        d.querySelector('[role="date"]').classList.add("selected"),
          d.querySelector('[role="calendarMode"]').classList.add("selected"),
          d.querySelector('[role="clockMode"]').classList.remove("selected"),
          d.querySelector('[role="hour"]').classList.remove("selected"),
          d.querySelector('[role="minute"]').classList.remove("selected"),
    ...
    createShowHourHandler: function (a, b, c) {
      return function () {
        var d = b.querySelector('[role="header"]');
        d.querySelector('[role="calendarMode"]').classList.remove("selected"),
          d.querySelector('[role="date"]').classList.remove("selected"),
          d.querySelector('[role="clockMode"]').classList.add("selected"),
          d.querySelector('[role="hour"]').classList.add("selected"),
          d.querySelector('[role="minute"]').classList.remove("selected"),
    ...
    createShowMinuteHandler: function (a, b, c) {
      return function () {
        ...
        d.querySelector('[role="calendarMode"]').classList.remove("selected"),
          ...
          d.querySelector('[role="clockMode"]').classList.add("selected"),
          d.querySelector('[role="hour"]').classList.remove("selected"),
          d.querySelector('[role="minute"]').classList.add("selected"),
        ...
        : ((d = gj.core.parseDate(b, e.format, e.locale)),
          d
            ? ((c = document.body.querySelector(
              ...
              gj.datepicker.methods.selectDay(a, c, e.datepicker, d),
              gj.timepicker.methods.setAttributes(c, e.timepicker, d),
              (a.element.value = b))
            : (a.element.value = ""),
          a);
    },
    destroy: function (a) {
      gj.datepicker.methods.destroy(a);
    },
  }),
  ...
  (GijgoDateTimePicker = function (a, b) {
    var c = this,
    ...
    return (
      ...
      "true" !== a.getAttribute("data-datetimepicker") && d.init.call(c, b),
      c
    );
  }),
  (GijgoDateTimePicker.prototype = new gj.widget()),
  (GijgoDateTimePicker.constructor = GijgoDatePicker),
  (GijgoDateTimePicker.prototype.getConfigJS =
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.datetimepicker = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoDateTimePicker(this[0], null)), b[a]))
              return b[a].apply(
                this[0],
                Array.prototype.slice.call(arguments, 1)
              );
          ...
          return new GijgoDateTimePicker(this[0], a);
        }
      };
    })(jQuery),
  ...
  (gj.slider.methods = {
    init: function (a) {
      return (
        gj.widget.prototype.initJS.call(this, a, "slider"),
        this.element.setAttribute("data-slider", "true"),
        gj.slider.methods.initialize(
          this.element,
          gijgoStorage.get(this.element, "gijgo")
        ),
        this
    ...
    initialize: function (a, b) {
      ...
      (a.style.display = "none"),
        "wrapper" !== a.parentElement.attributes.role
          ? ((c = document.createElement("div")),
            c.setAttribute("role", "wrapper"),
        ...
        b.width && (c.style.width = b.width + "px"),
        gj.core.addClasses(c, b.style.wrapper),
        (d = a.querySelector('[role="track"]')),
        null == d &&
          ((d = document.createElement("div")),
          d.setAttribute("role", "track"),
          c.appendChild(d)),
        gj.core.addClasses(d, b.style.track),
        (e = a.querySelector('[role="handle"]')),
        null == e &&
          ((e = document.createElement("div")),
          e.setAttribute("role", "handle"),
          c.appendChild(e)),
        (f = a.querySelector('[role="progress"]')),
        null == f &&
          ((f = document.createElement("div")),
    ...
    createClickHandler: function (a, b, c, d) {
      return function (e) {
        ...
        "true" !== c.getAttribute("drag") &&
          ((f = gj.core.position(a.parentElement)),
    ...
    value: function (a, b, c) {
      ...
      return void 0 === c
        ...
        : (a.setAttribute("value", c),
          (b.value = c),
          (e = a.parentElement.querySelector('[role="track"]')),
          (d = gj.core.width(e) / (b.max - b.min)),
          (f = a.parentElement.querySelector('[role="handle"]')),
          (f.style.left = (c - b.min) * d + "px"),
          (g = a.parentElement.querySelector('[role="progress"]')),
          (g.style.width = (c - b.min) * d + "px"),
          gj.slider.events.slide(a, c),
          a);
    },
    destroy: function (a) {
      var b = gijgoStorage.get(a, "gijgo"),
        c = a.parentElement;
      return (
        b &&
          (c.removeChild(c.querySelector('[role="track"]')),
          c.removeChild(c.querySelector('[role="handle"]')),
          c.removeChild(c.querySelector('[role="progress"]')),
          $(a).unwrap(),
          $(a).off(),
          gijgoStorage.remove(a, "gijgo"),
          a.removeAttribute("data-type"),
          a.removeAttribute("data-guid"),
          a.removeAttribute("data-slider"),
  ...
  (gj.slider.events = {
    ...
    slide: function (a, b) {
      return a.dispatchEvent(new CustomEvent("slide", { value: b }));
    },
  }),
  (GijgoSlider = function (a, b) {
    var c = this,
      d = gj.slider.methods;
    return (
      (c.element = a),
      ...
      (c.destroy = function () {
        return d.destroy(this.element);
      }),
      "true" !== a.getAttribute("data-slider") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.slider = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoSlider(this[0], null)), b[a]))
              return b[a].apply(
                this[0],
                Array.prototype.slice.call(arguments, 1)
              );
          ...
          return new GijgoSlider(this[0], a);
        }
      };
    })(jQuery),
  ...
  (gj.colorpicker.methods = {
    ...
    createPicker: function (a, b) {
      ...
      return (
        c.setAttribute("role", "popup"),
        gj.core.addClass(c, b.style.picker),
        c.setAttribute("guid", a.getAttribute("data-guid")),
        c.html("test"),
        c.hide(),
        $("body").append(c),
        $picker
  ...
  (GijgoColorPicker = function (a, b) {
    ...
    return (
      ...
      "true" !== a.getAttribute("data-colorpicker") && d.init.call(c, b),
      c
    );
  }),
  ...
  "undefined" != typeof jQuery &&
    (function (a) {
      a.fn.colorpicker = function (a) {
        ...
        if (this && this.length) {
          if ("object" != typeof a && a) {
            if (((b = new GijgoColorPicker(this, null)), b[a]))
              return b[a].apply(this, Array.prototype.slice.call(arguments, 1));
            throw "Method " + a + " does not exist.";
          }
          return new GijgoColorPicker(this, a);
        }
      };
    })(jQuery);
